...
var handleOrientationAllowed = function handleOrientationAllowed(image, options) {
  if (!options.orientationAllowed) return; // handle max size. If image is wider than higher we make sur that maxWidth is bigger than maxHeight
  ...
  return new Promise(function (resolve, reject) {
    ...
    image.onload = function () {
      ...
      var _options$maxWidth = options.maxWidth,
          ...
          lessCrop = options.lessCrop; // Define ratio to have the biggest image allowed
...
var imagePrepare = function imagePrepare(blob, options) {
...
exports.imagePrepare = imagePrepare;
