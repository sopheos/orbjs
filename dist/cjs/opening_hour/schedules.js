...
var Schedules = /*#__PURE__*/function () {
  ...
  (0, _createClass2.default)(Schedules, [{
    key: "getPreview",
      ...
      for (var i = 0; i < this.schedules.length; i += 1) {
        ...
        for (var _index = 0; _index < weekData.length; _index++) {
          ...
          if (scheduleType >= weekData[_index].type) {
            ...
            var open = !!schedule.time.open; // Today state
            ...
            if (scheduleType === weekData[_index].type) {
              ...
              if (_index === 0) {
                ...
                isOpen = (_isOpen = isOpen) !== null && _isOpen !== void 0 ? _isOpen : scheduleIsOpen;
              }
    ...
    value: function concatWeek(week) {
      ...
      var prevTime = null;
      var listDays = [];
      week === null || week === void 0 ? void 0 : week.forEach(function (times, index) {
