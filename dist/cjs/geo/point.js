...
var Point = /*#__PURE__*/function () {
  ...
  function Point() {
    ...
    (0, _defineProperty2.default)(this, "rad_lat", null);
    (0, _defineProperty2.default)(this, "rad_lon", null);
    this.lat = lat;
    this.lon = lon;
  }
  ...
  (0, _createClass2.default)(Point, [{
    ...
    value: function insideGeoCoordinates(coords) {
      ...
      var inside = Point.insideVertice(this.lon, this.lat, coords[0]); // Holes
    ...
    value: function fromMn95() {
      ...
      var x = (n - 1200000) / 1000000; // Calculer la longitude et la latitude dans l'unité [10000"]
      ...
      lat_i -= 0.002528 * x * x;
      lat_i -= 0.0447 * y * y * x;
      lat_i -= 0.0140 * x * x * x; // Convertir la longitude et la latitude dans l'unité [°]
...
exports.Point = Point;
(0, _defineProperty2.default)(Point, "EARTH_RADIUS", 6378137);
