...
export var FileUpload = /*#__PURE__*/function () {
  ...
  function FileUpload(options) {
    ...
    _defineProperty(this, "timeUpload", null);

    _defineProperty(this, "progress", new Subject());

    _defineProperty(this, "complete", new Subject());

    _defineProperty(this, "success", new Subject());

    _defineProperty(this, "error", new Subject());

    _defineProperty(this, "options", void 0);

    _defineProperty(this, "cancelRequest", void 0);

    _defineProperty(this, "started", false);

    _defineProperty(this, "initialProgress", 0);

    _defineProperty(this, "lastFormData", void 0);
  ...
  _createClass(FileUpload, [{
    ...
    value: function onProgress() {
      return this.progress.asObservable().pipe(filter(function (value) {
        return value !== null;
      }));
    }
    /**
    ...
    value: function onError() {
      return this.error.asObservable().pipe(filter(function (value) {
        return value !== null;
      }));
    }
    /**
    ...
    value: function onComplete() {
      return this.complete.asObservable().pipe(filter(function (value) {
        return value !== null;
      }));
    }
    /**
    ...
    value: function onSuccess() {
      return this.success.asObservable().pipe(filter(function (value) {
        return value !== null;
      }));
    }
    /**
    ...
    key: "execRequest",
    value: function () {
      var _execRequest = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime.mark(function _callee(formData) {
        var _this4 = this;
                ...
                axiosConfig = {
                  ...
                  onUploadProgress: function onUploadProgress(progress) {
                    return setTimeout(function () {
                      return _this4.progress.next(_this4.initialProgress + progress.loaded / progress.total * (100 - _this4.initialProgress));
                    });
                  }
                };
                start = Date.now(); // Send upload request

                axios.request(axiosConfig).then(function (success) {
                  ...
                  if (!axios.isCancel(error)) setTimeout(function () {
